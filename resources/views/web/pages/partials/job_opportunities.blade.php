        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8">
            <div class="positions">
              ...
              <a href="{{ 'hu.apply.show', ['slug' => $job->slug]) }}" class="defbtn"><i class="icon-arrow-right"></i>{{ $job->title }}</a>
              @empty
              <a href="{{ 'hu.apply.show') }}" class="defbtn"><i class="icon-arrow-right"></i>{{ $attributes['cta_title'] }}</a>
              @endforelse
            </div>
          </div>
        </div>
